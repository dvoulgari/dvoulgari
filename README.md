...
Utilizing a transformer-based foundation model for single-cell genomics to interpret cell states.

Python, Transformers

🏥 Breast Cancer ML

Building predictive models to classify breast cancer tumors using various ML algorithms.

Python, Scikit-learn, XGBoost

🖼️ Medical Image CNN

Custom CNN & VGG16 implementation for pneumonia detection in X-ray images.

Python, TensorFlow, OpenCV

🔬 ChIP-Seq Pipeline

Full shell-based workflow for ChIP-seq analysis (QC, Mapping, Peak Calling).

Bash, Samtools, Bowtie2
...
🐈 Cat lover: My debugging partners often have paws.

<div align="center">
<i>"Data is just a clue to the biological reality."</i>
</div>
